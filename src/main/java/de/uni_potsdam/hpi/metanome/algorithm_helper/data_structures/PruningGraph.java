...
public class PruningGraph {
	...
	protected final Map<ColumnCombinationBitset, List<ColumnCombinationBitset>> columnCombinationMap = new HashMap<ColumnCombinationBitset, List<ColumnCombinationBitset>>();

	protected final List<ColumnCombinationBitset> OVERFLOW = new LinkedList<ColumnCombinationBitset>();
	...
	public PruningGraph(int numberOfColumns, int overflowTreshold, boolean positiveFeature) {
		...
		this.allBitsSet = new ColumnCombinationBitset().setColumns(setBits);
	}
